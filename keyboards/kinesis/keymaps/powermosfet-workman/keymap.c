...
#define LAYER_PIN_SYMBOLS LINE_PIN25
#define LAYER_PIN_NUMBERS LINE_PIN24

void keyboard_pre_init_user(void){
    setPinOutput(LAYER_PIN_SYMBOLS);
    setPinOutput(LAYER_PIN_NUMBERS);
}
...
[_BASE] = LAYOUT(
	...
	KC_K   ,KC_L   ,KC_COMM,KC_DOT ,S_SLASH, KC_RGUI,
		_______,_______,_______,_______,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    writePin(LAYER_PIN_SYMBOLS, !layer_state_cmp(state, _SYMBOLS));
    writePin(LAYER_PIN_NUMBERS, !layer_state_cmp(state, _NUMBERS));
